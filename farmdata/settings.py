...
ROOT_URLCONF = 'farmdata.urls'


# Python dotted path to the WSGI application used by Django's runserver
WSGI_APPLICATION = 'farmdata.wsgi.application'
...
STATIC_ROOT = os.environ.get('STATIC_ROOT', '{}/farmdata/static/'.format(BASE_DIR))
...
MEDIA_ROOT = os.environ.get('MEDIA_ROOT', '{}/farmdata/media/'.format(BASE_DIR))
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': (
        # 'farmdata.core.auth.jwt.JWTAuthentication',
    ),

    'DEFAULT_PERMISSION_CLASSES': (
        'farmdata.core.permissions.AllowSafeMethods',
    ),
